  ...
  res.render('skills', {
    ...
    main: {
      ...
      hobbies: [
        ...
        { name: 'velo', isMain: true },
        { name: 'tennis', isMain: false },
      ],
    },
    footer,
  })
...
//           ↙ тут вводимо шлях (PATH) до сторінки
router.get('/icon_bootstrap', function (req, res) {
  // res.render генерує нам HTML сторінку

  //            ↙ cюди вводимо назву файлу з сontainer
  res.render('icon_bootstrap', {
    layout: 'bootstrap',
  })
  //                  ↑↑ сюди вводимо JSON дані
})
...
//           ↙ тут вводимо шлях (PATH) до сторінки
router.get('/css_1', function (req, res) {
  // res.render генерує нам HTML сторінку
